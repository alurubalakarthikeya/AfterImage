  ...
  return (
    <section
      ...
      style={
        heroSrc
          ? undefined
          : { background: 'linear-gradient(150deg, #0a0a0a 0%, #1a1a1a 58%, #2c2c2c 100%)' }
      }
    >
      {heroSrc && (
        <>
          ...
          <span
            ...
            style={{
              background:
                'linear-gradient(96deg, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.72) 46%, rgba(0,0,0,0.34) 76%, rgba(0,0,0,0.54) 100%)',
            }}
          />
        </>
      )}
